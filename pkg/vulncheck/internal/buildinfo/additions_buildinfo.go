...
// SymbolInfo is derived from cmd/pkg/objfile/elf.go:symbols, symbolData.
...
// PCLNTab is derived from cmd/pkg/objfile/elf.go:pcln.
...
// SymbolInfo is derived from cmd/pkg/objfile/pe.go:findPESymbol, loadPETable.
...
// PCLNTab is derived from cmd/pkg/objfile/pe.go:pcln.
...
// SymbolInfo is derived from cmd/pkg/objfile/macho.go:symbols.
...
// SymbolInfo is derived from cmd/pkg/objfile/macho.go:pcln.
