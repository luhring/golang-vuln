...
// Package pkg contains functionality for x/vuln.
package pkg
...
// Keep in sync with vulndb/pkg/database/generate.go.
const (
	// GoStdModulePath is the pkg Go module path string used
	// when listing vulnerabilities in standard library.
	GoStdModulePath = "stdlib"

	// GoCmdModulePath is the pkg Go module path string used
